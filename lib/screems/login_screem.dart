              ...
              CardContainer(
                child: Column(
                  children: [
                    ...
                    Text('Iniciar Sesion',style: Theme.of(context).textTheme.headline6),
      ...
      child: Column(
        children: [
          ...
          TextFormField(
            ...
            validator: (value) =>(value == "") ? "Ingrese nombre de usuario" : null,
          ),
          ...
          TextFormField(
            ...
            validator: (value) =>(value == "") ? "Ingrese una contraseña" : null,
          ),
